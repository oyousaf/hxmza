...
assert(products.every(p=>p.variants.length===3))
...
console.log('PASS: GBP catalogue, 39 variants, customer registration/login, basket quantity updates, delivery, manual test checkout, order history, unauthorized account rejection.')
